...
'about_organisation' => 'About GakuNin',
'faq' => 'FAQ',
'help' => 'Help',
'privacy' => 'Privacy',
...
'additional_info' => '<a href="https://www.gakunin.jp/" target="_blank">GakuNin</a> provides innovative, unique internet services for the Japanese universities and internet users.',
...
'hint_idp' => ' Hint! IdP',
'map_button' => 'Map',
'reg_button' => 'Sign up on this IdP',
'map_tooltip' => 'You can view the map to select your organisation',
'reg_tooltip' => 'You can sign up on this IdP if you are not registered with any IdP yet.',
'geolocation_tooltip' => 'Provide the latitude and longitude of this device and nearby IdPs will be displayed on top of the list.',
...
'geolocation_err3' => 'Location of this device can not be determined',
'geolocation_err4' => 'Timed out',
'category_radio' => 'Filter:',
'close_button' => 'Close',
'geolocation_button' => 'Present place',
'no_hint_msg' => 'No hint based on client information such as IP address and domain name.',
'no_geolocation_msg' => 'Because you did not provide your location, nearby IdPs can not be displayed.<br />You can provide the location with "Present place" button at the right of the map.',
'near_idp' => 'Nearby IdPs',
);
...
'about_organisation' => '&Uuml;ber GakuNin',
'faq' => 'FAQ',
'help' => 'Hilfe',
'privacy' => 'Datenschutz',
...
'about_organisation' => '&Agrave; propos de GakuNin',
'faq' => 'FAQ',
'help' => 'Aide',
...
'about_organisation' => 'Informazioni su GakuNin',
'faq' => 'FAQ',
'help' => 'Aiuto',
...
'about_organisation' => 'Sobre a GakuNin',
'faq' => 'FAQ',
'help' => 'Ajuda',
'privacy' => 'Privacidade',
...
'title' => '所属機関選択',
'header' => '所属機関の選択',
'about_federation' => 'フェデレーションとは',
'about_organisation' => '学認とは',
'faq' => 'FAQ',
'help' => 'ヘルプ',
'privacy' => 'プライバシー',
...
'permanent_cookie_notice' => 'デフォルトの所属機関を選択することで，このブラウザで他のサービスにアクセスした場合に，IdPの選択画面をスキップすることができます．現在セット中のデフォルト所属機関は:',
...
'confirm_permanent_selection' => '選択した機関をデフォルト所属機関として保存してもよいですか？　複数の機関にアカウントを持っている場合は，この機能を利用しないで下さい．',
'save_button' => '保存',
'access_host' => 'サービス<tt>\'%s\'</tt>を利用するために所属機関を選択もしくは入力してください',
'select_idp' => '所属している機関を選択',
'search_idp' => '所属している機関を入力',
'remember_selection' => 'ブラウザ起動中は自動ログイン',
'additional_info' => '<a href="https://www.gakunin.jp/" target="_blank">GakuNin</a>は，学術認証フェデレーションの略です．',
...
'arguments_missing' => 'ウェブサーバーが無効なクエリを受け付けました．いくつかの必要な引数が不足しています．<br>以下の引数を受け付けました:',
'valid_request_description' => '有効なリクエストでは少なくとも，<tt>shire</tt>と<tt>target</tt>の適正な値を必要とします．オプショナルな引数である<tt>providerID</tt>，<tt>origin</tt>や<tt>redirect</tt>を送信することにより，ウェブブラウザを所属機関IdPに自動的にリダイレクトさせることができます．',
'valid_saml2_request_description' => '有効なSAML2のリクエストでは少なくとも，<tt>entityID</tt>と<tt>return</tt>の適正な値を必要とします．<tt>return</tt>の代わりにSPメタデータに<tt>DiscoveryResponse</tt>エンドポイントを含めても良いです．オプショナルな引数である<tt>isPassive</tt>, <tt>policy</tt>や<tt>returnIDParam</tt>を送信することにより，ウェブブラウザを所属機関にIdPに自動的にリダイレクトさせることができます．',
...
'most_used' => '最もよく利用されている機関',
'invalid_return_url' => 'リターンURL <tt>\'%s\'</tt> が不正です',
'unverified_return_url' => 'リターンURL <tt>\'%s\'</tt> はSP <tt>\'%s\'</tt> のものとみなされません',
'unknown_sp' => 'SP <tt>\'%s\'</tt> はメタデータに存在しないので不明です',
...
'reg_tooltip' => '登録されているIdPがない場合、こちらより登録することができます',
