...
'valid_saml2_request_description' => '有効なSAML2のリクエストでは少なくとも，<tt>entityID</tt>と<tt>return</tt>の適正な値を必要とします．<tt>return</tt>の代わりにSPメタデータに<tt>DiscoveryResponse</tt>エンドポイントを含めても良いです．オプショナルな引数である<tt>isPassive</tt>, <tt>policy</tt>や<tt>returnIDParam</tt>を送信することにより，ウェブブラウザを所属機関IdPに自動的にリダイレクトさせることができます．',
