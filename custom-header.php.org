			...
			<table border="0" cellpadding="0" cellspacing="0" width="600" class="outer-box">
				<tr>
					<td class="switchaai">
						...
						<br>
						<a href="https://www.gakunin.jp/" class="switchaai-link"><?php echo getLocalString('about_aai'); ?></a>&nbsp;:&nbsp;<a href="https://www.gakunin.jp/" class="switchaai-link"><?php echo getLocalString('about_switch'); ?></a>&nbsp;:&nbsp;<a href="https://www.gakunin.jp/" class="switchaai-link"><?php echo getLocalString('faq') ?></a>&nbsp;:&nbsp;<a href="https://www.gakunin.jp/" class="switchaai-link"><?php echo getLocalString('help') ?></a>&nbsp;:&nbsp;<a href="https://www.gakunin.jp/" class="switchaai-link"><?php echo getLocalString('privacy') ?></a>
<!-- Body: Start -->
